    ...
    <div className="mx-auto min-h-screen max-w-320 px-4 pt-28 pb-20 md:px-6">
      ...
      <header className="mb-16">
        <div className="mb-6 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div className="max-w-3xl">
            ...
            <p className="border-l-2 border-primary-container pl-4 text-base text-on-surface-variant italic md:text-lg">
              Designed and evolved scalable backend systems powering inventory, ordering, invoicing,
        ...
        <div className="flex flex-wrap gap-2">
          {['NESTJS', 'TYPESCRIPT', 'POSTGRESQL', 'REDIS', 'KUBERNETES', 'MICROSERVICES'].map(
            (tag) => (
              <span
                key={tag}
      ...
      <div className="bento-grid">
        ...
        <section className="relative col-span-12 overflow-hidden rounded-xl border border-outline-variant bg-surface-container p-6 shadow-xl md:col-span-7 md:p-8">
          <span className="step-number absolute top-4 right-4 text-5xl opacity-20 select-none md:text-6xl">
            01
          </span>
          ...
          <div className="space-y-4 text-base leading-relaxed text-on-surface-variant">
            <p>
              The legacy Distributor Management System (DMS) was struggling to keep pace with rapid
              business growth. As the distributor network expanded, the monolithic architecture
              encountered severe performance degradation during peak ordering windows.
            </p>
            <p>
              Inventory synchronization was prone to race conditions, leading to over-ordering and
              financial discrepancies. The system lacked the necessary abstraction to handle complex
              regional tax logic and high-frequency real-time stock updates across thousands of
              concurrent sessions.
            </p>
          </div>
        </section>
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-on-surface-variant md:text-sm">
                  Handle 800+ Requests Per Second (RPS) reliably.
                </span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-on-surface-variant md:text-sm">
                  99.9% uptime for financial transaction processing.
                </span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-on-surface-variant md:text-sm">
                  ACID compliance for inventory and wallet deductions.
                </span>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-on-surface-variant md:text-sm">
                  Ability to process 100K+ row CSV uploads for invoicing.
                </span>
              </div>
            </li>
          </ul>
        ...
        <section className="relative col-span-12 overflow-hidden rounded-xl border border-outline-variant bg-surface-container-low p-6 shadow-xl md:p-8">
          ...
          <h2 className="mb-8 text-center text-2xl font-bold text-on-surface">
            System Architecture
          </h2>
          ...
          <div className="relative flex flex-col items-center justify-center gap-4 md:flex-row">
            ...
            <span className="material-symbols-outlined rotate-90 text-outline md:rotate-0">
              trending_flat
            </span>
        ...
        <section className="relative col-span-12 rounded-xl border border-outline-variant bg-background p-6 shadow-xl md:col-span-6 md:p-8">
          ...
          <p className="mb-8 text-base leading-relaxed text-on-surface-variant">
            I took end-to-end ownership of the core backend services, focusing on architectural
            stability and system optimization. My primary objective was to refactor high-traffic
            endpoints and introduce robust queuing mechanisms to decouple synchronous processes.
          </p>
          ...
          <div className="space-y-4">
            <div className="rounded border border-outline-variant bg-surface-container p-4">
              <h4 className="mb-1 font-mono text-sm font-bold text-on-surface">
                Redis Caching Strategy
              </h4>
              <p className="text-xs text-on-surface-variant md:text-sm">
                Implemented a Write-Through cache for SKU availability to reduce DB read pressure by
                80%.
              </p>
            </div>
            <div className="rounded border border-outline-variant bg-surface-container p-4">
              ...
              <p className="text-xs text-on-surface-variant md:text-sm">
                Split the Monolith into targeted services: Identity, Inventory, and Order
                Orchestrator.
              </p>
            </div>
            <div className="rounded border border-outline-variant bg-surface-container p-4">
              ...
              <p className="text-xs text-on-surface-variant md:text-sm">
                Configured Horizontal Pod Autoscaler based on custom memory and CPU metrics for
                scaling stability.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm leading-relaxed text-on-surface-variant">
                Simultaneous orders for the same SKU led to "Phantom Stock" errors. I solved this by
                implementing <strong className="text-on-surface">Distributed Locking</strong> using
                Redis (Redlock algorithm) ensuring atomicity across the clustered environment.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed text-on-surface-variant">
                Complex JOINs in the invoicing module were taking upwards of 10 seconds. Optimized
                via <strong className="text-on-surface">Database Indexing</strong> and transitioning
                legacy synchronous exports to an{' '}
                <strong className="text-on-surface">Asynchronous Job Pipeline</strong> with BullMQ.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4">
              <div className="border-r border-outline-variant/30 text-center last:border-0">
                ...
                <div className="font-mono text-xs tracking-wider uppercase text-on-surface-variant">
                  Requests Per Second
                </div>
              </div>
              <div className="border-r border-outline-variant/30 text-center last:border-0">
