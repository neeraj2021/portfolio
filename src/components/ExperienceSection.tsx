...
export const ExperienceSection: React.FC = () => {
  return (
    <section
      className="border-y border-outline-variant bg-surface-container-low py-20"
      id="experience"
    >
        ...
        <div className="relative">
          ...
          <div className="relative mb-12 flex flex-col gap-8 md:flex-row">
            ...
            <div className="glass-card rounded-xl border border-[#334155] p-5 md:w-1/2">
              <p className="text-sm leading-relaxed text-on-surface-variant">
                Leading development of enterprise-scale microservices. Specialized in optimizing
                database performance and integrating agentic AI workflows into legacy stacks.
              </p>
            </div>
          </div>
          ...
          <div className="relative mb-12 flex flex-col gap-8 md:flex-row-reverse">
            ...
            <div className="glass-card rounded-xl border border-[#334155] p-5 md:w-1/2 md:text-right">
              <p className="text-sm leading-relaxed text-on-surface-variant">
                Architected a DMS platform that supported 50k+ sellers. Focused on high-availability
          ...
          <div className="relative flex flex-col gap-8 md:flex-row">
            ...
            <div className="glass-card rounded-xl border border-[#334155] p-5 md:w-1/2">
              <p className="text-sm leading-relaxed text-on-surface-variant">
                Developed full-stack web applications with React and Node.js. Optimized legacy APIs
